...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring(
        #"file:ac2fde62-8866-4e50-8f36-77d604bfd4e1.root", # ScoutingPFRun3 2024
        ...
        "file:0f36dd04-0983-4415-810e-f63c783656f0.root", # ScoutingPFRun3 2023D 
    ),
...
# select task to run
trigger_efficiency_task = trigger_efficiency_task_matrix["2023_late"]

# muon
muon_input_tag = cms.untracked.InputTag("hltScoutingMuonPacker", "", "HLT") # 2022-23
#muon_input_tag = cms.untracked.InputTag("hltScoutingMuonPackerNoVtx", "", "HLT") # 2024
